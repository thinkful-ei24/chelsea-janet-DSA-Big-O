...
//o(n) linear
//The run time complexity is proportionate to the input size
...
// O(n) Linear - grows in proportion to the input data set size
...
//Exercise 7 - Factorial
// O(n) Linear - grows in proportion to the input size
...
function fibonacciIterative(number) {
  let num1 = 1; // 1 2 3 5 8
  let num2 = 0; // 1 1 2 3 5
  let fib = null; // 1 1 2 3 5
  while (number > 0) {
    fib = num1;
    num1 = num1 + num2;
    num2 = fib;
